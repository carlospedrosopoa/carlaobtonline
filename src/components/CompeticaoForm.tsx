...
import { Trophy, ArrowLeft, Save, Plus, X, Users, User, PlayCircle, RotateCcw, Settings } from 'lucide-react';
        ...
        {competicaoId && jogos.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => router.push(`/app/arena/competicoes/${competicaoId}/jogos`)}
