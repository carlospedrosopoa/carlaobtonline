...
export async function POST(request: NextRequest) {
  try {
    ...
    // IMPORTANTE: Deve ser a URL de PRODUÇÃO do backend, não preview/deployment
    // O Infinite Pay precisa de uma URL estável e pública para chamar o webhook
    const backendUrl = process.env.NEXT_PUBLIC_API_URL || 'https://carlaobtonline.vercel.app';
