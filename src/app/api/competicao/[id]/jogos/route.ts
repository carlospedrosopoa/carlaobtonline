  ...
  try {
    ...
    const jogos = await Promise.all(jogosResult.rows.map(async (row) => {
      const jogo: any = {
        ...
        gamesAtleta1: row.gamesAtleta1 !== null && row.gamesAtleta1 !== undefined ? row.gamesAtleta1 : null,
        gamesAtleta2: row.gamesAtleta2 !== null && row.gamesAtleta2 !== undefined ? row.gamesAtleta2 : null,
